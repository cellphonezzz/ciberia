...
@section('content')
    ...
    <div class="content-wrapper">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Список жанров</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        ...
        <section class="content">
            ...
            <div>
                <a href="{{route('genres.create')}}" class="btn btn-success bg-teal mb-3">Добавить жанр</a>
            </div>
                            ...
                            <table class="table table-head-fixed text-nowrap">
                                ...
                                @foreach($genres as $genre)
                                    <tr>
                                        <td>{{$genre->id}}</td>
                                        <td>{{$genre->title}}</td>
                                        <td><a href="{{route('genres.show', $genre->id)}}"><i class="fa-solid fa-eye text-teal"></i></a> </td>
